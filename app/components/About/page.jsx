    ...
    <>
      <div className="flex flex-col relative text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center h-screen">
        ...
        <div className="space-y-10 px-2 md:px-10">
          ...
          <p className="text-xl">
            I'm a Developer with a passion for building websites and
            applications. I'm a passionate individual who loves to code and
            learn new technologies. I am currently working as a{" "}
            <span className="font-bold text-sky-500">System Engineer</span> at{" "}
            <span className="font-bold text-violet-800">Wipro Ltd</span>
          </p>
